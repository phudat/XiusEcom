...
public class XiusEcomHttpApiHostModule : AbpModule
{
    ...
    private void ConfigureVirtualFileSystem(ServiceConfigurationContext context)
    {
        ...
        if (hostingEnvironment.IsDevelopment())
        {
            ...
            {
                options.FileSets.ReplaceEmbeddedByPhysical<XiusEcomDomainSharedModule>(
                    Path.Combine(hostingEnvironment.ContentRootPath,
                        $"..{Path.DirectorySeparatorChar}XiusEcom.Domain.Shared"));
                options.FileSets.ReplaceEmbeddedByPhysical<XiusEcomDomainModule>(
                    Path.Combine(hostingEnvironment.ContentRootPath,
